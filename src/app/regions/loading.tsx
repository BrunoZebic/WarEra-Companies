      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-2">
            <div className="h-3 w-16 animate-pulse rounded bg-blue-900/50" />
            <div className="h-10 w-72 animate-pulse rounded-xl bg-blue-900/50" />
            <div className="h-4 w-[28rem] animate-pulse rounded bg-blue-900/40" />
          </div>
        ...
        <div className="flex justify-end">
          <div className="h-9 w-56 animate-pulse rounded-full bg-blue-900/50" />
        </div>
